...
//                { title: '⭐️ Рейтинг: ' + dictRating[currentState.rating], id: 'rating' },
        ...
        function doSearch(params) {
            ...
            var pageTitle = '🇹🇷⠀' + dictType[params.type];
        ...
        function addMenuButton() {
            ...
            var item = $('<li class="menu__item selector filter2-item" data-action="filter2"><div class="menu__ico"><svg><use xlink:href="./img/icons/other/tr.svg"></use></svg></div><div class="menu__text">Турецкие</div></li>');
