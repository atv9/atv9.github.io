...
(function () {
    'use strict';
		Lampa.SettingsApi.addParam({
			...
			var tubemenu = $('<li class="menu__item selector hide"><div class="menu__ico">' + TubeSVG + '</div><div class="menu__text" >YouTube</div></li>');
...
//			}
			tubemenu.on('hover:enter', function() {
					...
					else window.location.href = 'https://youtube.com/tv'
			})
 })();
/* End Кнопка YouTube */
